...
__name(getIsoWeekString, "getIsoWeekString");
var index_default = {
    ...
    <div class="footer">
      ...
      if (url.pathname === "/v1/telemetry/report-error") {
        ...
        try {
          ...
          const stack = String(report.stack || "").substring(0, 2e3);
      ...
      if (url.pathname === "/v1/admin/overview") {
        ...
        try {
          ...
          const currentWeekKey = getIsoWeekString(/* @__PURE__ */ new Date());
          ...
          users.forEach((u) => {
            ...
            if (u.createdAt) {
              ...
              if (!isNaN(uDate.getTime())) {
                ...
                if (daysMapUsers[dayKey] !== void 0) daysMapUsers[dayKey]++;
                if (weeksMapUsers[weekKey] !== void 0) weeksMapUsers[weekKey]++;
                if (monthsMapUsers[monthKey] !== void 0) monthsMapUsers[monthKey]++;
                if (yearsMapUsers[yearKey] !== void 0) yearsMapUsers[yearKey]++;
            ...
            (u.resumeDates || []).forEach((rd) => {
              ...
              if (!isNaN(rDate.getTime())) {
                ...
                if (daysMapResumes[dayKey] !== void 0) daysMapResumes[dayKey]++;
                if (weeksMapResumes[weekKey] !== void 0) weeksMapResumes[weekKey]++;
                if (monthsMapResumes[monthKey] !== void 0) monthsMapResumes[monthKey]++;
      ...
      if (url.pathname === "/v1/admin/users/hold") {
        ...
        if (!isNaN(hoursNum) && hoursNum > 0) {
          const untilDate = new Date(now.getTime() + hoursNum * 60 * 60 * 1e3);
